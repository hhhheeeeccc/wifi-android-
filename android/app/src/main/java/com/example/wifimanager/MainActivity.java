...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean scan = false; public Handler h = new Handler(Looper.getMainLooper());
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        adp = new DeviceAdapter(this, new ArrayList<Device>()); lv.setAdapter(adp);
    ...
    @Override public void onClick(View v) {
        if (v.getId() == R.id.toggleHotspot) {
            ...
            new Thread(new ToggleHotspotRunnable(hm, !hm.isHotspotEnabled(), s, p, h, this)).start();
    ...
    public void updateUI() {
        ...
        if (a && !scan) { scan = true; h.post(new ScanRunnable(this, repo, adp, h)); } else if (!a) scan = false;
    }
}
